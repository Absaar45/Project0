          ...
          <div class="card card-login">
              ...
              <div class="card-body">
               ...
               <span class="bmd-form-group">
                ...
                <div style="padding-left: 50px;">
                  <font  style=" color: red;"> <sf:errors path="address"></sf:errors> </font>
                </div>
              </span>
               ...
               <span class="bmd-form-group">
                  ...
                  <sf:input  path="state"  class="form-control" placeholder="${enterState}"/>
                  
                  
                </div>
                <div style="padding-left: 50px;">
                  <font  style=" color: red;"> <sf:errors path="state"></sf:errors> </font>
                </div>
              </span>
               ...
               <span class="bmd-form-group">
                  ...
                  <sf:input  path="city"  class="form-control" placeholder="${enterCity}"/>
                  
                  
                </div>
                <div style="padding-left: 50px;">
                  <font  style=" color: red;"> <sf:errors path="city"></sf:errors> </font>
                </div>
              </span>
                ...
                <div style="padding-left: 50px;">
                  <font  style=" color: red;"><sf:errors path="phoneNo"/></font>
                </div>
              </span>
